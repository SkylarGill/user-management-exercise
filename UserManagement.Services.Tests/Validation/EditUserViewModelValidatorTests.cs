...
public class EditUserViewModelValidatorTests
{
    ...
    private static EditUserViewModel GetValidModel() =>
        new()
        {
            Forename = "David",
            Surname = "NonActive",
    ...
    private EditUserViewModelValidator CreateService()
    {
        ...
        var service = new EditUserViewModelValidator(currentDateProvider.Object);
        return service;
    }
}